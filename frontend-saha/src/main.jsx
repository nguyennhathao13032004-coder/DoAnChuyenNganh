...
import HealthRecordDashboard from './HealthRecordDashboard';
      ...
      <CartProvider>
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/tu-van" element={<HealthSurvey/>} />
            <Route path="/ho-so-y-te" element={<HealthRecordDashboard />} />
            <Route path="/phong-kham-ai" element={<AiHealthQuiz />} />
